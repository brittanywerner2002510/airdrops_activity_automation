class MoonbeamConstants:
    NAME = "Moonbeam"
    NATIVE_TOKEN = "GLMR"
    RPC = "https://rpc.ankr.com/moonbeam"
    CHAIN_ID = 1284
    STARGATE_CHAIN_ID = 126
    ...
    MERKLY_CONTRACT_ADDRESS = "0x766b7aC73b0B33fc282BdE1929db023da1fe6458"
    MERKLY_MAX_TRANSFER = "6.11"
    MERKLY_NETWORKS = [
        {
            "network": "Optimism",
        ...
        {
            "network": "Harmony ONE",
            "icon": "interface/img/harmony.svg"
        },
        {
            "network": "DFK",
