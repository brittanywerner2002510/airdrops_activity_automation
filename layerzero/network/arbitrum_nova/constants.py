class ArbitrumNovaConstants:
    NAME = "Arbitrum Nova"
    NATIVE_TOKEN = "ETH"
    RPC = "https://arbitrum-nova.publicnode.com"
    CHAIN_ID = 42170
    STARGATE_CHAIN_ID = 175
    ...
    MERKLY_CONTRACT_ADDRESS = "0x484c402b0c8254bd555b68827239bace7f491023"
    ...
    MERKLY_NETWORKS = [
        ...
        {
            "network": "OKExChain",
            "icon": "interface/img/okex.svg"
        },
        {
            "network": "Moonbeam",
            "icon": "interface/img/moonbeam.svg"
        },
        {
            "network": "Moonriver",
            "icon": "interface/img/moonriver.svg"
        },
        {
            "network": "Core DAO",
            "icon": "interface/img/coredao.svg"
        },
        {
            "network": "Metis",
